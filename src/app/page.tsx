...
export default function Home() {
  ...
  return (
    <div>
      <div className="wrapper mt-2 h-screen">
        <div className="grid h-auto flex-1 grid-cols-[1fr] grid-rows-[minmax(50px,auto)_593px_auto] gap-2 md:grid-cols-[1fr_1fr_1fr] md:grid-rows-[minmax(50px,auto)_545px_266px_300px] lg:grid-cols-[320px_1fr_320px] lg:grid-rows-[minmax(50px,auto)_600px_minmax(260px,auto)_560px]">
          <Ticker />
          {!isMobile && <Orderbook />}
          <TradingPanel />
