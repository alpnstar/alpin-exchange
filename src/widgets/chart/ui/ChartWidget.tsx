	...
	return (
		<div className={cn('w-full h-full flex flex-col', className)}>
			<div className="flex gap-2 p-2 bg-gray-800">
				<button onClick={() => setCurrentInterval(ChartInterval.OneSecond)} className={cn('p-2 rounded', { 'bg-blue-500': currentInterval === ChartInterval.OneSecond })}>1s</button>
				<button onClick={() => setCurrentInterval(ChartInterval.OneMinute)} className={cn('p-2 rounded', { 'bg-blue-500': currentInterval === ChartInterval.OneMinute })}>1m</button>
				<button onClick={() => setCurrentInterval(ChartInterval.FiveMinutes)} className={cn('p-2 rounded', { 'bg-blue-500': currentInterval === ChartInterval.FiveMinutes })}>5m</button>
