...
export const SettingsSvg: FC<{ className?: string }> = ({className}) => {
    return (
        <svg className={cn("bn-svg !w-[24px] !h-[24px] text-PrimaryText cursor-pointer mx-[5px] hover:text-PrimaryYellow", className)}
