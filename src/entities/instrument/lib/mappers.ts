...
export function mapBinanceKlineToAreaData(kline: BinanceKline): AreaData {
  return {
...
export const mapBinanceStreamKlineToCandlestickData = (
  streamData: BinanceStreamKline,
): CandlestickData => ({
...
export const mapBinanceStreamKlineToBinanceKline = (
  streamKline: BinanceStreamKline,
): BinanceKline => {
  return [
