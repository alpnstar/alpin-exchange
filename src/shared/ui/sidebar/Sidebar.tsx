		...
		<Dialog.Portal>
			...
			<Dialog.Content
				className={cn(sidebarVariants({
					side,
					sizeVariant
				}), 'data-[state=open]:animate-in data-[state=open]:fade-in data-[state=open]:slide-in-from-right data-[state=closed]:animate-out data-[state=closed]:fade-out data-[state=closed]:slide-in-from-left duration-200', className)}
				{...props}
			>
