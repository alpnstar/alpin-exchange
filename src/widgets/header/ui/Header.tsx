      ...
      <div className="mx-auto flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden lg:block">
            <ul className="flex items-baseline gap-5 font-medium">
              <li>
                <a
                  href="#"
                  className="text-PrimaryText hover:text-PrimaryYellow"
                >
                  Buy Crypto
                </a>
              </li>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <button className="hidden xl:block" aria-label="FAQ">
              <svg
                className="fill-PrimaryText hover:fill-PrimaryYellow h-6 w-6"
                viewBox="0 0 24 24"
            ...
            <button className="hidden xl:block" aria-label="FAQ">
              <svg
                className="fill-PrimaryText hover:fill-PrimaryYellow h-6 w-6 cursor-pointer"
                viewBox="0 0 24 24"
                xmlns="http://www.w3.org/2000/svg"
              >
